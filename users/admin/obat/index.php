...
$carikode = $conn -> query("SELECT MAX(id_obt) FROM obat");
...
?>
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="index.php"><em class="fa fa-shopping-cart">&nbsp;</em> Obat</a></li>
                         ...
                         <table id="lookup" class="table table-striped" data-toggle="table" data-select-item-name="toolbar1">
                            ...
                            <tr>
                                ...
                                <td>
                                     ...
                                     <a class="btn btn-danger" href="obat_h.php?id=<?php echo $data[0]; ?>"><span class="glyphicon glyphicon-remove" onclick="return confirm('Hapus?')"></span></a>
                                </td>
                            </tr>
                            <?php } ?>
                                 </tbody>
			...
			<div class="modal-content">
              ...
              <form action="" method="POST" class="form-horizontal">
				<div class="modal-body">
                    <div class="form-group">
                      <label class="control-label col-sm-3" for="nama">Kode Obat:</label>
                       <div class="col-sm-4">
                       <input type="text" class="form-control" name="kd_o" value="<?php echo $kode_otomatis; ?>" readonly>
                       </div>
                     </div>
    
                    <div class="form-group">
                      <label class="control-label col-sm-3" for="nama">Nama Obat:</label>
                      <div class="col-sm-5">
                      <input type="text" class="form-control" name="nama_o" maxlength="35" required="">
                      </div>
                    </div>

                    <div class="form-group">
                      <label class="control-label col-sm-3" for="nama">Jenis Obat:</label>
                      <div class="col-sm-5">
                      <input type="text" class="form-control" name="jenis_o" maxlength="35" required="">
                      </div>
                    </div>
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                      <input type="number" class="form-control" name="harga_o" maxlength="35" required="">
                      </div>
                    </div>
				</div>
...
if (isset($_GET['id'])){
	$id = $_GET['id'];
	$sql = $conn -> query("SELECT * FROM obat WHERE id_obt = '$id'");
			...
			<div class="col-lg-12">
				...
				<div class="modal-body">
                    <div class="form-group">
                      <label class="control-label col-sm-3" for="nama">Kode Obat:</label>
                       <div class="col-sm-4">
                       <input type="text" class="form-control" name="kd_o" value="<?php echo $data[0]; ?>" readonly>
                       </div>
                     </div>
                    ...
                    <div class="form-group">
                      <label class="control-label col-sm-3" for="nama">Nama Obat:</label>
                      <div class="col-sm-5">
                      <input type="txt" class="form-control" name="e_nama_o" maxlength="35" value="<?php echo $data[1]; ?>" required="">
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      <label class="control-label col-sm-3" for="nama">Jenis Obat:</label>
                      <div class="col-sm-5">
                      <input type="text" class="form-control" name="e_jenis_o" maxlength="35" value="<?php echo $data[2]; ?>" required="">
                      </div>
                    </div>
					...
					<div class="form-group">
                      <label class="control-label col-sm-3" for="nama">Harga:</label>
                      <div class="col-sm-5">
                      <input type="text" class="form-control" name="e_harga_o" maxlength="35" value="<?php echo $data[3]; ?>" required="">
                      </div>
                    </div>
				</div>
				<div class="modal-footer">
...
$up = $conn -> query("INSERT INTO obat VALUES('$kode_otomatis', '$b', '$c', '$d')");
    if($up) { ?>
...
if(isset($_POST['edit'])){
	$edit = $_POST['kd_o'];
    $edit_a = $_POST['e_nama_o'];
    $edit_b = $_POST['e_jenis_o'];
	$edit_c = $_POST['e_harga_o'];

$ed = $conn -> query("UPDATE obat SET nama_obt = '$edit_a',
                                        jenis_obt = '$edit_b',
										harga = '$edit_c'
                                       WHERE id_obt = '$edit'");
    if($ed) { ?>
